<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\xy\wuliu\public/../application/admin\view\merchant\add_merchant.html";i:1560776339;}*/ ?>
    ...
    layui.config({
        ...
        $("#upload1s").click(function(){
            hhtc.upload_one(function(res){
                $('#demo2').append('<img src="'+ res +'" class="layui-upload-img"><input type="hidden" name="autuimg[]" value="'+res+'"/>')
            })
        });
        //公司实景
        $('#upload').click(function () {
            hhtc.upload_one(function(res){
                $('#demo3').append('<img src="'+ res +'" class="layui-upload-img"><input type="hidden" name="factimg[]" value="'+res+'"/>')
            })
        });
        //商户头像
...
//        function a() {
//            var a =  $("#prov option:selected").attr("val")//第1个
//            var b =  $("#city option:selected").attr("val")//第2个
//            var c =  $("#area option:selected").attr("val")//第3个
//            var d =  $("#provs option:selected").attr("val")//第1个
//            var e =  $("#citys option:selected").attr("val")//第2个
//            var f =  $("#areas option:selected").attr("val")//第3个
//        }
    })
</script>
<script>
