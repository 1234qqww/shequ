<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"D:\xy\project\shequshop\public/../application/admin\view\order\order_order_end.html";i:1564561887;}*/ ?>
...
<script>
    layui.config({
        ...
        //加载数据
        base_table(table,'list','/admin/order/order_order_end',cols);
