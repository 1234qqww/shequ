<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\xy\project\shequshop\public/../application/admin\view\order\order_list.html";i:1564473934;}*/ ?>
...
<script>
    layui.config({
        ...
        //加载数据
        base_table(table,'list','/admin/order/order_list',cols);
