<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xy\project\shequshop\public/../application/admin\view\report\index.html";i:1564131455;}*/ ?>
...
<script>
  layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
    ...
    var insTb = table.render({
      elem: '#userTable',
      url: "<?php echo url('report/storelists'); ?>",
      page: true,
      cellMinWidth: 100,
      cols: [[
        ...
        { title: '操作',align:"center",templet:function(e){
            return  '<a href="<?php echo url("report/reports"); ?>?user_id='+e.user_id+'" class="layui-btn layui-btn-primary layui-btn-xs">回复</a>'
          }},
      ]]
    });
    // 添加
