<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/www/wwwroot/sq.zxrhyc.cn/public/../application/admin/view/subject/index.html";i:1562835428;}*/ ?>
...
<script>
  layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
    ...
    var insTb = table.render({
      elem: '#userTable',
      url: "<?php echo url('subject/lists'); ?>",
      page: true,
      cellMinWidth: 100,
      cols: [[
