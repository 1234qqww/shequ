<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\xy\project\shequshop\public/../application/admin\view\subject\update_topic.html";i:1564131455;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="head" id="head" placeholder="请输入标题" type="text" class="layui-input" maxlength="20"
                       lay-verType="tips" lay-verify="required" value="<?php echo !empty($topic)?$topic->head:''; ?>" required/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="sid"  id="sid" lay-search=""　>
                    ...
                    <?php if(is_array($subject) || $subject instanceof \think\Collection || $subject instanceof \think\Paginator): $i = 0; $__LIST__ = $subject;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($topic->sid==$vo->id): ?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="layui-upload-list">
                    ...
                    <img class="layui-upload-img" id="demo1" src="<?php echo $topic->picture; ?>" style="width:100px;height:100px">
                    <?php else: ?>
                    <img class="layui-upload-img" id="demo1"  style="width:100px;height:100px">
                    <?php endif; ?>
                    <p id="demoText1"></p>
                    <input type="hidden" id="picture" name="picture" value="<?php echo !empty($topic)?$topic->picture:''; ?>">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="hidden" value="<?php echo !empty($topic)?$topic->image:''; ?>" id="image">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label class="layui-form-label">内容</label>
            <div class="layui-input-block">
                <script id="editor" type="text/plain" style="width:100%;height:500px;margin: 0 auto"><?php echo !empty($topic)?$topic->content:''; ?></script>
            </div>
            <input type="hidden" id="content" name="content" value="<?php echo !empty($topic)?$topic->content:''; ?>">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input name="browse" id="browse" placeholder="请输入浏览量" type="text" class="layui-input" maxlength="20"
                       lay-verType="tips" lay-verify="required" value="<?php echo !empty($topic)?$topic->browse:''; ?>" required/>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">商品链接</label>
            <div class="layui-input-block">
                <button type="button" class="layui-btn" id="images"><i class="layui-icon"></i>修改商品链接</button>
            </div>
            <input type="hidden" id="goods_id" value="<?php echo !empty($topic)?$topic->goods_id:''; ?>">
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">作者</label>
            <div class="layui-input-block">
                <input name="author" id="author" placeholder="请输入作者名称" type="text" class="layui-input" maxlength="20"
                       lay-verType="tips" lay-verify="required" value="<?php echo !empty($topic)?$topic->author:''; ?>" required/>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <div class="layui-upload-list">
                    <?php if($topic->headimg): ?>
                    <img class="layui-upload-img" id="demo2" src="<?php echo $topic->headimg; ?>" style="width:100px;height:100px">
                    <?php else: ?>
                    <img class="layui-upload-img" id="demo2"  style="width:100px;height:100px">
                    <?php endif; ?>
                    <p id="demoText2"></p>
                    <input type="hidden" id="headimg" name="headimg" value="<?php echo !empty($topic)?$topic->headimg:''; ?>">
                </div>
            </div>
        </div>
    ...
    layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
        ...
        $('#images').click(function () {
            ...
            layer.open({
                ...
                ,shade: 0.2
                ,maxmin: true
                ,content:"<?php echo url('subject/shopgood'); ?>?goods_id="+goods_id
                ,btn: ['保存关闭', '取消'] //只是为了演示
                ,yes: function(){
