<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xy\project\shequshop\public/../application/admin\view\banner\slide.html";i:1562721973;}*/ ?>
...
<script>
    layui.config({
        ...
        var cols=[[
            ...
            ,{field: 'position',align: 'center', title: '展示位置',toolbar:'#position'}
        ...
        //加载数据
        base_table(table,'list','/admin/banner/slide',cols);
