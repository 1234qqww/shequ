<<<<<<< HEAD
<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\xy\project\shequshop\public/../application/admin\view\commodity\add_commodity.html";i:1562202381;}*/ ?>
=======
<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\xy\project\shequshop\public/../application/admin\view\commodity\add_commodity.html";i:1562289052;}*/ ?>
...
<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
    ...
    <div class="layui-tab-content" style="height: 100px;">
        <div class="layui-tab-item layui-show">
            <div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form-role" style="padding:35px 45px;">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="shop_price"  lay-verify="required" value="" placeholder=请输入市场价 autocomplete="off" class="layui-input" >
                    </div>
                    <label class="layui-form-label">本店价</label>
                    <div class="layui-input-inline">
                        <input type="text"  name=""  lay-verify="required" value="" autocomplete="off" placeholder=请输入本店价 class="layui-input" >
                    </div>
                    <label class="layui-form-label">成本价</label>
                    <div class="layui-input-inline">
                        <input type="text"  name="name"  lay-verify="required" value="" autocomplete="off" placeholder=请输入成本价 class="layui-input" >
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_free_shipping" lay-skin="switch" lay-text="是|否" checked lay-filter="switchTest" >
                    </div>
                </div>
                <div class="layui-form-item" style="display:none" id="youfei">
        ...
        <div class="layui-tab-item">
            <div class="layui-form" lay-filter="layuiadmin-form-role" id="layuiadmin-form" style="padding:35px 45px;">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="store_count"  lay-verify="required" placeholder=请输入库存 value="" autocomplete="off" class="layui-input" >
                    </div>
                ...
                <div class="control-group"  id="guige" style="display: none">
                    ...
                    <div class="controls">
                        ...
                        <button id="update_table"  type="button" class="layui-btn layui-btn-sm layui-btn-normal">刷新规格项目表</button>
                    </div>
                </div>
        ...
        <div class="layui-tab-item">
            <div class="layui-form" lay-filter="layuiadmin-form-role"  style="padding:35px 45px;">
