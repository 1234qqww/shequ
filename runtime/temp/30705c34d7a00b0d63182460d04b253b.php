<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\xy\project\shequshop\public/../application/admin\view\commodity\edit_commodity.html";i:1565685749;}*/ ?>
        ...
        <div class="layui-tab-content" style="height: 100px;">
            <div class="layui-tab-item layui-show">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="radio" name="is_jifen"   lay-filter="erweima"  value="0" title="正常商品"  <?php if($goods['is_jifen']==0): ?>checked<?php endif; ?>>
                        <input type="radio" name="is_jifen"   lay-filter="erweima"  value="1" title="积分商品"  <?php if($goods['is_jifen']==1): ?>checked<?php endif; ?> >
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number" name="sort" lay-verify="required" value="<?php echo $goods['sort']; ?>" placeholder=请输入排序号 autocomplete="off" class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="goods_gjc"  value="<?php echo $goods['goods_gjc']; ?>"  placeholder=请输入关键词 autocomplete="off" class="layui-input" >
                    </div>
                    <div class="layui-form-mid layui-word-aux">商品关键词,能准确搜到商品的,比如 : 海尔电视|电视 之类的</div>
                </div>
                <div class="layui-form-item" <?php if($goods['is_jifen']==1): ?>style="display: none"<?php endif; ?>>
                    <label class="layui-form-label">赠送积分</label>
                    <div class="layui-input-inline">
                        <input type="number"  name="give_integral"   value="<?php echo $goods['give_integral']; ?>"  placeholder=请输入赠送积分 autocomplete="off" class="layui-input" >
                    </div>
                    <div class="layui-form-mid layui-word-aux">商品赠送积分，赠送的积分可以在积分商城进行购买商品</div>
                </div>
                <div class="layui-form-item" id="consume_jifen" <?php if($goods['is_jifen']==0): ?>style="display: none"<?php endif; ?> >
                    <label class="layui-form-label">消耗积分</label>
                    <div class="layui-input-inline">
                        <input type="number"  name="consume_jifen"   value="<?php echo $goods['consume_jifen']; ?>"  placeholder=请输入使用积分 autocomplete="off" class="layui-input" >
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="number"  name="sales_sum"  value="<?php echo $goods['sales_sum']; ?>"  placeholder=请输入商品展示销量 autocomplete="off" class="layui-input" >
                    </div>
                    <div class="layui-form-mid layui-word-aux">商品展示销量是用户看到的销量</div>
                </div>
                <div class="layui-form-item" id="menu_one"  <?php if($goods['is_jifen']==1): ?>style="display: none"<?php endif; ?>>
                    <label class="layui-form-label">商品类型</label>
                    <div class="layui-input-inline">
                        <select name="parent_id_1"  id="parent_id_1" model="select" lay-filter="menu_one" >
                            <?php if(is_array($cat_list1) || $cat_list1 instanceof \think\Collection || $cat_list1 instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_list1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$goods['goods_category_id1']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="layui-input-inline">
                        <select model="select"  name="parent_id_2" id="parent_id_2"  lay-filter="menu_two">
                            <?php if(is_array($cat_list2) || $cat_list2 instanceof \think\Collection || $cat_list2 instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$goods['goods_category_id2']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <div class="layui-input-inline">
                        <select model="select"  name="parent_id_3" id="parent_id_3"  lay-filter="menu_there">
                            <?php if(is_array($cat_list3) || $cat_list3 instanceof \think\Collection || $cat_list3 instanceof \think\Paginator): $i = 0; $__LIST__ = $cat_list3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$goods['goods_category_id']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item" id="goods_jifenid"   <?php if($goods['is_jifen']==0): ?>style="display: none"<?php endif; ?>>
                    ...
                    <div class="layui-input-inline">
                        <select name="goods_jifenid"  >
                            ...
                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id']==$goods['goods_jifenid']): ?>selected<?php endif; ?>><?php echo $vo['name']; ?></option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="market_price"  lay-verify="required" value="<?php echo $goods['market_price']; ?>" placeholder=请输入市场价 autocomplete="off" class="layui-input" >
                    </div>
                    <label class="layui-form-label">本店价</label>
                    <div class="layui-input-inline">
                        <input type="text"  name="shop_price"  lay-verify="required" value="<?php echo $goods['shop_price']; ?>" autocomplete="off" placeholder=请输入本店价 class="layui-input" >
                    </div>
                    <label class="layui-form-label">成本价</label>
                    <div class="layui-input-inline">
                        <input type="text"  name="cost_price"  lay-verify="required" value="<?php echo $goods['cost_price']; ?>" autocomplete="off" placeholder=请输入成本价 class="layui-input" >
                    </div>
                    <div class="layui-form-mid layui-word-aux" id="price1" <?php if($goods['is_jifen']==1): ?>style="display: none"<?php endif; ?>>尽量填写完整，有助于于商品销售的数据分析</div>
                    <div class="layui-form-mid layui-word-aux" id="price2" <?php if($goods['is_jifen']==0): ?>style="display: none"<?php endif; ?>>积分商品只使用积分兑换，本店价请填写0</div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_free_shipping" lay-skin="switch" lay-text="是|否"  lay-filter="switchTest" <?php if($goods['is_free_shipping']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item"  id="youfei" style=<?php if($goods['is_free_shipping']==1): ?>display:none<?php endif; ?>>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_tuijian" lay-skin="switch" lay-text="是|否" <?php if($goods['is_tuijian']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否显示</label>
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_show"  lay-skin="switch" lay-text="是|否" <?php if($goods['is_show']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否热卖</label>
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_hot"  lay-skin="switch" lay-text="是|否" <?php if($goods['is_hot']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否新品</label>
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_newshop"  lay-skin="switch" lay-text="是|否" <?php if($goods['is_newshop']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">是否上架</label>
                    <div class="layui-input-block">
                        <input type="checkbox" name="is_on_sale"  lay-skin="switch" lay-text="是|否"  <?php if($goods['is_on_sale']==1): ?>checked<?php endif; ?>>
                    </div>
                </div>
            </div>
            <div class="layui-tab-item">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text"  name="store_count"   placeholder=请输入库存 <?php if($goods['is_model']==1): ?>readOnly style="background-color:#ddd" <?php else: ?>value=<?php echo $goods['store_count']; endif; ?>   autocomplete="off" class="layui-input" >
                    </div>
                    <input type="radio" name="is_reduce" value="2" title="付款减库存" <?php if($goods['is_reduce']==2): ?>checked<?php endif; ?>>
                    <input type="radio" name="is_reduce" value="1" title="永不减库存" <?php if($goods['is_reduce']==3): ?>checked<?php endif; ?>>
                </div>
                <div class="layui-form-item">
                    <label class="layui-form-label">规格</label>
                    <div class="layui-input-inline">
                        <input type="checkbox" name="is_model" lay-skin="primary" title="启用产品规格" lay-filter="is_model" <?php if($goods['is_model']==1): ?>checked<?php endif; ?>>
                    </div>
                    <div class="layui-form-mid layui-word-aux">启用商品规格后，商品的价格及库存以商品规格为准</div>
                </div>
                <div class="control-group"  id="guige" <?php if($goods['is_model']==0): ?> style="display: none"<?php endif; ?>>
            ...
            <div class="control-group lv1 item-attr"><label class="control-label">规格名称</label>
                ...
                <div class="controls lv2s">
                    <?php foreach($item['itemattrval'] as $value): ?>
                    <div style="margin-top: 5px;"><input type="text" name="lv2" data-id="<?php echo $value['id']; ?>" value="<?php echo $value['attr_value']; ?>" placeholder="参数名称">
