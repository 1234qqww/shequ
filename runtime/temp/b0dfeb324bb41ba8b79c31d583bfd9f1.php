<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xy\project\shequshop\public/../application/admin\view\retail\index.html";i:1564131455;}*/ ?>
...
<script>
  layui.use(['layer', 'form', 'table', 'util', 'admin', 'formSelects'], function () {
    ...
    var insTb = table.render({
      elem: '#userTable',
      url: "<?php echo url('retail/retaillists'); ?>",
      page: true,
      cellMinWidth: 100,
      cols: [[
    ...
    table.on('tool(userTable)', function(obj){
      ...
      if(obj.event === 'edit'){
        ...
        layer.confirm('确定要驳回申请吗?', function(index){
          ...
          //console.log(id)
          $.ajax({
            url: "<?php echo url('retail/reject'); ?>?id="+id,
            type: 'delete',
            data: {id:id},
            dataType: 'json',
            success: function(){
